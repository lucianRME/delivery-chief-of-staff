...
**On screen:** Start on the empty Delivery Chief of Staff dashboard.
...
**On screen:** Point to the three CSV upload controls and sample scenario selector.
...
**On screen:** Select **At Risk Programme**, then click **Load Selected Sample Scenario**.
...
**On screen:** Click **Download Executive Report** and briefly show the Markdown report.
...
**On screen:** Return to the headline score and leadership decision.
